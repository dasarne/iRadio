...
*/
//#define LOG_FILTER "DISPLAY,SCREEN,STREAM-S,SELECT-S,SPEED-S,MAIN,AUDIO,WIFI,PREFS,ENCODER"
#define LOG_FILTER "DISPLAY,SCREEN,STREAM-S,SELECT-S,SPEED-S,MAIN,ENCODER"
