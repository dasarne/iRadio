...
*/
//#define LOG_FILTER "DISPLAY,SCREEN,STREAM-S,OPTION-S,SPEED-S,MAIN,AUDIO,WIFI,PREFS,ENCODER"
#define LOG_FILTER "DISPLAY,SCREEN,STREAM-S,OPTION-S,SPEED-S,MAIN,ENCODER"
